...

    {
      ...
      render: (text: any, record: any) => (
        <div className="d-flex align-items-center">
          <Link to="#" className="avatar avatar-sm border rounded p-1 me-2">
            <ImageWithBasePath
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="mb-3 ">
                        ...
                        <Select options={planName} className="select2" />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="mb-3 ">
                        ...
                        <Select options={planType} className="select2" />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="mb-3 ">
                        ...
                        <Select options={currency} className="select2" />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="mb-3 ">
                        ...
                        <Select options={language} className="select2" />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="mb-3">
                        ...
                        <Select options={role} className="select2" />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="mb-0">
